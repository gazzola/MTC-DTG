...
The files used, such as books_only_metrics_run.txt, dataset1_dataset2.csv, books.txt, metrix_3.txt, among others. These are metrics extracted from the corpora using NILC Metrics.
